...
You can use this project to collect high-quality tool call data.
...
> **Note:** After generation, be sure to use `mini-cursor mcp-config` or directly edit `mcp_config.json` to fill in your `BOCHAAI_API_KEY`. Without it, online query tools will not work!
...
MIT[English](README.md) | [中文说明 (Chinese)](README_zh.md)
